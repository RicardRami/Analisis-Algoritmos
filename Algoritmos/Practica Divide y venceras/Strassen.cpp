...
/* Practica Divide y Venceras Multiplicación de matrices

Josue Loredo Cortes
Frida Estrada Borja
Ricardo Daniel Ramírez Rodríguez
...
int main()
{
   ...
   printf("Ingresa el tamaño de la primera matriz\n");
   printf("Filas A: ");
   scanf("%d",&f1); // Tamaño de la primera matriz
   printf("Columnas A:");
   scanf(" %d",&c1);
   printf("Filas B: ");
   scanf(" %d",&f2); // Tamaño de la segunda matriz
   printf("Columnas B:");
   scanf(" %d ",&c2);
...
// Hallar las matrices M.
   ...
   M[0]=multiplicamatriz(A[0][0],B[0][0],num/2);
   
   M[1]=multiplicamatriz(A[0][1],B[1][0],num/2);

   M[2]=multiplicamatriz(A[0][0],B[0][1],num/2);
   
   M[3]=multiplicamatriz(A[0][1],B[1][1],num/2);
   
   M[4]=multiplicamatriz(A[1][0],B[0][0],num/2);

   M[5]=multiplicamatriz(A[1][1],B[1][0],num/2);

   M[6]=multiplicamatriz(A[1][0],B[0][1],num/2);
   
   M[7]=multiplicamatriz(A[1][1],B[1][1],num/2);
